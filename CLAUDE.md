...
- **이미지 설명 모델 (3개):**
  - gemma4:e2b (15~20초, TTS명: "구글 투지")
  - gemma4:e4b (30~40초, TTS명: "구글 포지")
  - llama3.2-vision (2~3분, TTS명: "라마비전")
- **문서 OCR 모델 (4개):**
...
### 이미지 분석 (3개 모델)
- **구글 투지 (gemma4:e2b):** 가장 빠름 (15~20초)
- **구글 포지 (gemma4:e4b):** 균형 (30~40초)
- **라마비전 (llama3.2-vision):** 가장 상세 (2~3분)
- 음성 명령: "일번", "이번", "삼번" 또는 모델명
...
**주요 변경:** 7개 모델 음성 우선 플로우, 자동 이미지 분류, olmOCR2 추가
